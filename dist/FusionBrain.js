...
class FusionBrain {
    ...
    CreateGenerateQuery(query, negativeQuery, style, modelId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (task.status = 'INITIAL') {
                    ...
                    const data = yield this.Polling(task);
                    return data;
                }
                else {
                    throw new Error('');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            while (true) {
                try {
                    ...
                    const response = yield (0, node_fetch_1.default)(TEXT2IMAGE_CHECK_URL + task.uuid, {
...
//# sourceMappingURL=FusionBrain.js.map